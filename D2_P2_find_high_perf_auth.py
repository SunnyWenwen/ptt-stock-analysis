...
# 算出獲利最大值
result['max'] = result.apply(lambda x: x[['10', '30', '60', '120', '180', '360']].dropna().max(), axis=1)
result['article_CT'] = 1
...
# 10天獲利最高的人
perf10 = auth_perf_df.sort_values(by=['10'], ascending=False).head(10)
# 30天獲利最高的人
...
# 高手ID全部取出
high_perf_auth = pd.concat(
    [perf10['author0'], perf30['author0'], perf60['author0'], perf120['author0'], perf180['author0'],
